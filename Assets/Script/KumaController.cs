...
//     // public GameDirector gameDirector; // GameManagerの参照

//     // GameDirectorの設定を確認するコード例
...
//         actionsOut[0] = Input.GetAxis("PS5HorizontalL");
//         actionsOut[1] = Input.GetAxis("PS5VerticalL");
//     }
